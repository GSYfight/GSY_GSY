<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\php\GSY\public/../application/index\view\product\product.html";i:1506319392;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="row">
            ...
            <div class="right fr" style="z-index: 100">
                ...
                <div class="addCart">
                    ...
                    <div class="caozuo">
                        <div class="d1 fl">
                            <a class="fl left goods_sub">-</a>
                            <input type="text" class="fl goods_num" maxlength="2" value="1">
                            <a class="fl right goods_add">+</a>
                        </div>
