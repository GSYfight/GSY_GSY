<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\PHPfile\GSY\public/../application/index\view\cart\cartlist.html";i:1506335031;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="data">
            <table>
                ...
                <tr>
                    ...
                    <td class="sp">
                        <img src="__STATIC__/index/./img/cart_goods1.jpg" alt="">
                        <span><a href="">沙拉瓶子 绿3瓶红3瓶</a></span>
                    </td>
                    <td class="sj">
                        ￥<span>169.00</span>
                    </td>
                ...
                <tr class="end">
                    ...
                    <td colspan="4">
                        <div class="allDiv fl">
                            <p class="p1">订单金额</p>
                            <p class="p2">￥<span class="allMoney">169.00</span></p>
                            <p class="p3">不含运费</p>
                        </div>
            ...
            <div class="bottomDiv">
                <div class="mingxi fr">
                    <h2>金额明细</h2>
                    <ul>
                        <li class="li1"><span class="left">商品小计</span><span class="right">￥<span class="allMoney">169.00</span></span></li>
                        <li class="li2"><hr></li>
                        <li class="li3"><span class="left ">购买金额</span><span class="right">￥<span class="allMoney">169.00</span></span></li>
