<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"F:\php\GSY\public/../application/admin\view\image\addgoodspic.html";i:1506076598;}*/ ?>
                            ...
                            <div id="horizontal-form">
                                <form class="form-horizontal" role="form" action="<?php echo url('Image/addGoodsPic'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="cate_id" class="col-sm-2 control-label no-padding-right">图片分类</label>
                                        <div class="col-sm-6">
