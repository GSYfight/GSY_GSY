<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\PHPfile\GSY\public/../application/index\view\index\index.html";i:1506294498;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="nav">
        <div class="navImg">
            <img src="__STATIC__/index/img/nav1.jpg" >
        </div>
        <div class="navBtn">
            <ul class="borderD">
                <li>717美食5件5折</li>
