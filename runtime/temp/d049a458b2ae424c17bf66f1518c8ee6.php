<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"E:\PHP\GSY\public/../application/index\view\index\index.html";i:1506065568;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="regou borderD divModel">
        ...
        <?php foreach($data as $val): if($val['path'] == '1,%'): $__FOR_START_13414__=1;$__FOR_END_13414__=8;for($i=$__FOR_START_13414__;$i < $__FOR_END_13414__;$i+=1){ ?>
