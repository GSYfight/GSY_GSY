<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\PHPfile\GSY\public/../application/index\view\product\product.html";i:1506064555;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="main">
        <div class="row">
            <div class="fl current">
                ...
                <a href="#" class="sp" style="background-image: url(__STATIC__/index/./img/pro_s2.jpg)"></a>
                <a href="#" class="sp" style="background-image: url(__STATIC__/index/./img/pro_s3.jpg)"></a>
                <a href="#" class="sp" style="background-image: url(__STATIC__/index/./img/pro_s4.jpg)"></a>
            </div>
            <div class="sp_large">
                <div class="cenTop">
